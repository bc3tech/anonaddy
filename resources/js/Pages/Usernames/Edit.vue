                ...
                <div class="flex">
                  <div class="relative w-full">
                    <input
                      ...
                      class="block w-full min-w-0 flex-1 rounded-none rounded-l-md border-0 py-2 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:text-white dark:bg-white/5"
